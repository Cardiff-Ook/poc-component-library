...
export class DocumentsListItem {
  ...
  static get is() { return "documents-list-item"; }
  static get originalStyleUrls() {
    return {
      "$": ["documents-list-item.css"]
    };
  }
  ...
  static get properties() {
    return {
      "document": {
        ...
        "mutable": false,
        "complexType": {
          "original": "DocumentDataInterface | string",
          "resolved": "DocumentDataInterface | string",
          "references": {
            "DocumentDataInterface": {
              "location": "import",
              "path": "../../../interfaces/documentDataInterface"
            }
          }
        },
        "required": false,
  ...
  static get events() {
    return [{
        ...
        "docs": {
          "tags": [],
          "text": "Event: downloadDocument: EventEmitter\nEvent to fire if data validates"
        },
        "complexType": {
          "original": "any",
          "resolved": "any",
