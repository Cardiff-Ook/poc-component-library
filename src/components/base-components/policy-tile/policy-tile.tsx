...
import { PolicyDetailsInterface } from '../policy-details/policy-details'
...
export class PolicyTile {
  ...
  render() {
    return (
      <div key={this.policydetails.id} class="MyPoliciesPage_tileContainer__CASCC MyPoliciesPage_policyCovers__3cFyO">
        <div>
