...
const NavBar = class {
  ...
  render() {
    return (index.h("nav", { class: "jut__ApplicationHeader__subApplicationHeader" }, index.h("ul", { class: "jut__NavigationContent__navigationContent jut__TopNavigation__topNavigation", role: "menubar", tabindex: "0" }, this._arrayData.map((item = {}) => index.h("li", { class: "jut__NavigationContent__topNavigationItem", role: "none" }, index.h("a", { "aria-current": "page", class: this.isActive(item.isActive), tabindex: "0", role: "menuitem", onClick: (e) => this.menuToggle(e) }, index.h("div", { class: "jut__NavBarItem__titleWrapper inlineOverride" }, index.h("span", { class: "jut__NavBarItem__title" }, item.name))))), index.h("li", { class: "jut__NavigationContent__topNavigationItem", role: "none" }))));
  }
};
