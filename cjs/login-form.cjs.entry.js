...
const LoginForm = class {
  constructor(hostRef) {
    ...
    this.loginShouldOccur = index.createEvent(this, "loginShouldOccur", 7);
    /**
  ...
  render() {
    return (index.h("div", { id: "loginFormContainer" }, index.h("form", { class: "loginForm" }, index.h("div", { class: "loginFormFields" }, index.h("div", { class: "inputFieldContainer" }, index.h("label", null, "Policyholder Email ", index.h("span", { class: "req" }, "*")), index.h("div", { class: "inputField" }, index.h("input", { name: "username", required: true }))), index.h("div", { class: "inputFieldContainer" }, index.h("label", null, "Password ", index.h("span", { class: "req" }, "*")), index.h("div", { class: "inputField" }, index.h("input", { name: "password", type: "password", required: true }))), index.h("error-message", { hidden: this.showError, errorMessage: this._errorMessage }), index.h("p", { class: "parent_recovery_links" }, index.h("a", { class: "recovery_links", href: "/myaccount/passwordreset/", target: "_blank" }, index.h("div", { class: "markdownWrapper" }, index.h("span", { class: "markdownParagraph" }, index.h("span", { class: "markdownText" }, "Forgotten Password"))))), index.h("p", { class: "parent_recovery_links" }, index.h("a", { class: "recovery_links", href: "/myaccount/login/help-menu", target: "_blank" }, index.h("div", { class: "markdownWrapper" }, index.h("span", { class: "markdownParagraph" }, index.h("span", { class: "markdownText" }, "Need help logging in?"))))), index.h("button", { class: "submitButton", type: "button", onClick: () => { this.login(); } }, index.h("span", { class: "buttonLabel" }, "Login"))))));
  }
