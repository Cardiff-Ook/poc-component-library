...
const LoginForm = class {
  ...
  render() {
    return (index.h("div", { id: "loginFormContainer" }, index.h("form", { class: "loginForm" }, index.h("div", { class: "loginFormFields" }, index.h("div", { class: "inputFieldContainer" }, index.h("label", null, "Policyholder Email ", index.h("span", { class: "req" }, "*")), index.h("div", { class: "inputField" }, index.h("input", { name: "username", required: true }))), index.h("div", { class: "inputFieldContainer" }, index.h("label", null, "Password ", index.h("span", { class: "req" }, "*")), index.h("div", { class: "inputField" }, index.h("input", { name: "password", type: "password", required: true }))), this.forgotPasswordUrl ?
      index.h("p", { class: "forgot" }, index.h("stencil-route-link", { url: this.forgotPasswordUrl }, "Forgot Password?")) : '', index.h("button", { class: "submitButton", type: "button", onClick: () => { this.login(); } }, index.h("span", { class: "buttonLabel" }, "Login"))))));
  }
