...
const PolicyDetails = class {
  ...
  render() {
    if (this._arrayData !== undefined && this._arrayData.length > 0) {
      return (index.h("div", { id: "policyCoverMainContainer", class: "MyPoliciesPage_policyCoverMainContainer__3bkpG" }, index.h("div", { id: "policyCoverContainerIterables" }, this._arrayData.map((policy = {}, index$1) => index.h("policy-tile", { policydetails: policy, policyindex: index$1 })))));
    }
    else {
...
exports.policy_details = PolicyDetails;
