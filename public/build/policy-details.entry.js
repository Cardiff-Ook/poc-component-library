...
const PolicyDetails = class {
  ...
  render() {
    console.log(this._arrayData);
    if (this._arrayData !== undefined && this._arrayData.length > 0) {
      return (h("div", { id: "policyCoverMainContainer", class: "MyPoliciesPage_policyCoverMainContainer__3bkpG" }, h("div", { id: "policyCoverContainerIterables" }, this._arrayData.map((policy = {}) => h("policy-tile", { policydetails: policy })))));
    }
    else {
