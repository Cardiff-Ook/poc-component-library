...
const AccountDetails = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.editUserDetails = createEvent(this, "editUserDetails", 7);
  }
  ...
  static get style() { return accountDetailsCss; }
}, [0, "account-details", {
    "user": [1]
  }]);
function defineCustomElement() {
  ...
  const components = ["account-details"];
  components.forEach(tagName => { switch (tagName) {
    case "account-details":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, AccountDetails);
      }
      break;
  } });
}

export { AccountDetails as A, defineCustomElement as d };
