...
const DocumentsList = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  }
  ...
  static get style() { return documentsListCss; }
}, [0, "documents-list", {
    "coverdetails": [1]
  }]);
function defineCustomElement() {
  ...
  const components = ["documents-list", "documents-list-item"];
  components.forEach(tagName => { switch (tagName) {
    case "documents-list":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DocumentsList);
      }
      break;
...
export { DocumentsList as D, defineCustomElement as d };
